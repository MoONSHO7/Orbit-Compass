...
## Gotchas
- The 24-marker budget retains navigation/category priority. Distance with stable key ties orders icons within levels 1–24 of the ribbon's 32-level footprint; non-interactive selection badges use level 25.
...
- POIs stay at 1.2x within 30% of range, then scale through 1.0x at 50%, 0.75x at 75%, and 0.5x at the limit. HandyNotes uses the same curve and icon size.
